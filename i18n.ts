...
const enTranslations = {
  ...
  'Reorder article {{articleTitle}}': 'Reorder article {{articleTitle}}',
  ...
  'Choose the main color for UI elements.': 'Choose the main color for UI elements.',
  'Blue': 'Blue',
  'Purple': 'Purple',
  'Green': 'Green',
  'Orange': 'Orange',
  ...
  'Restore Pre-Import Backup': 'Restore Pre-Import Backup',
  'A backup was created before your last import. You can restore it if something went wrong.': 'A backup was created before your last import. You can restore it if something went wrong.',
  'Restore Backup': 'Restore Backup',
  'Are you sure you want to restore the pre-import backup? This will overwrite all current data.': 'Are you sure you want to restore the pre-import backup? This will overwrite all current data.',
  'Backup restored successfully! The app will now reload.': 'Backup restored successfully! The app will now reload.',
...
const deTranslations = {
  ...
  'Reorder article {{articleTitle}}': 'Artikel "{{articleTitle}}" neu anordnen',
  ...
  'Theme': 'Theme',
  'Choose your preferred color theme.': 'Wählen Sie Ihr bevorzugtes Farbschema.',
  'Light': 'Hell',
  'Dark': 'Dunkel',
  'System': 'System',
  'Accent Color': 'Akzentfarbe',
  'Choose the main color for UI elements.': 'Wählen Sie die Hauptfarbe für UI-Elemente.',
  'Blue': 'Blau',
  'Purple': 'Lila',
  'Green': 'Grün',
  'Orange': 'Orange',
